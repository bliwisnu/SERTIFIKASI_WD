        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded p-4">
                    <h3 class="text-dark mb-5">Tambah User</h3>
                    <form action="/tambahUser/store" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="mobile" name="no_hp" class="form-control" id="exampleInput"
                                aria-describedby="emailHelp">
                        </div>
                        <div class="form mb-3">
                        ...
                        <div class="button-group d-flex justify-content-between">
                            <button type="submit" class="btn w-25 btn-success mt-3">Tambah</button>
